...
## Installation
```bash
curl -sSL https://raw.githubusercontent.com/CREAsTIVE/regru-set-ip/master/install.sh | sudo bash
```
...
## Uninstall
```bash
curl -sSL https://raw.githubusercontent.com/CREAsTIVE/regru-set-ip/master/uninstall.sh | sudo bash
```
